...
def generate_gaussian_smooth_controls(T, N=1, nu=1, std=3.0, sigma_range=[2.0, 8.0]):
...
if __name__ == "__main__":
    ...
    omega_0 = np.random.uniform(-2, 2, (N, 1))
    ...
    controls = generate_gaussian_smooth_controls(T=T, N=N, nu=Pendulum.nu)
